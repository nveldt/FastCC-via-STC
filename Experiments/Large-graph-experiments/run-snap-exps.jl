...
snaps = [
    ...
    matwrite("snap-results/mfp_results_$(graph)", Dict("graph_stats"=>graph_stats,"runtimes_cc"=>runtimes_cc,"results_cc"=>results_cc,"runtimes_cd"=>runtimes_cd,"results_cd"=>results_cd))
