...
scatter!(f,x,Hr[p],markerstrokewidth = 0, label = "KaPoCE heur.")
scatter!(f,x,LPr[p],markerstrokewidth = 0, label = "LP-STC+")
# savefig("pace_ratios.pdf")
...
scatter!(f,x,Ht,markerstrokewidth = 0, label = "KaPoCE heur")
# scatter!(f,x,LPt,markerstrokewidth = 0, label = "LP-STC+")
# savefig("pace_runtimes.pdf")
